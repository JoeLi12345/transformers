...
from transformers import Ngpt_customConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformers.models.ngpt_custom.modeling_tf_ngpt_custom import (
...
class TFNgpt_customModelTester:
    def __init__(
        self,
        parent,
    ):
    ...
    def create_and_check_ngpt_custom_model(self, config, input_ids, input_mask, head_mask, token_type_ids, *args):
        model = TFNgpt_customModel(config=config)
        inputs = {
            "input_ids": input_ids,
    ...
    def create_and_check_ngpt_custom_lm_head(self, config, input_ids, input_mask, head_mask, token_type_ids, *args):
        model = TFNgpt_customLMHeadModel(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_ngpt_custom_double_head(
        self, config, input_ids, input_mask, head_mask, token_type_ids, mc_token_ids, *args
    ):
        model = TFNgpt_customDoubleHeadsModel(config=config)
    ...
    def create_and_check_ngpt_custom_for_sequence_classification(
        ...
        model = TFNgpt_customForSequenceClassification(config)
...
@require_tf
class TFNgpt_customModelTest(TFModelTesterMixin, TFCoreModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (
        (TFNgpt_customModel, TFNgpt_customLMHeadModel, TFNgpt_customForSequenceClassification, TFNgpt_customDoubleHeadsModel)
        if is_tf_available()
        else ()
    )
    all_generative_model_classes = (TFNgpt_customLMHeadModel,) if is_tf_available() else ()
    test_head_masking = False
    test_onnx = True
    onnx_min_opset = 10

    def setUp(self):
        self.model_tester = TFNgpt_customModelTester(self)
    ...
    def test_ngpt_custom_lm_head(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_ngpt_custom_lm_head(*config_and_inputs)

    def test_ngpt_custom_double_head(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_ngpt_custom_double_head(*config_and_inputs)
    ...
    def test_model_from_pretrained(self):
        model_name = ""
        model = TFNgpt_customModel.from_pretrained(model_name)
    ...
    def test_onnx_runtime_optimize(self):
        ...
        for model_class in self.all_model_classes:
            ...
            if model_class in [TFNgpt_customForSequenceClassification, TFNgpt_customDoubleHeadsModel]:
                continue
...
@require_tf
class TFNgpt_customModelLanguageGenerationTest(unittest.TestCase):
    @slow
    def test_lm_generate_greedy_distilngpt_custom_batch_special(self):
        model = TFNgpt_customLMHeadModel.from_pretrained("distilbert/distilngpt_custom")
        tokenizer = GPT2Tokenizer.from_pretrained("distilbert/distilngpt_custom")
    ...
    @slow
    def test_lm_generate_sample_distilngpt_custom_batch_special(self):
        model = TFNgpt_customLMHeadModel.from_pretrained("distilbert/distilngpt_custom")
        tokenizer = GPT2Tokenizer.from_pretrained("distilbert/distilngpt_custom")
    ...
    @slow
    def test_lm_generate_greedy_distilngpt_custom_beam_search_special(self):
        model = TFNgpt_customLMHeadModel.from_pretrained("distilbert/distilngpt_custom")
        tokenizer = GPT2Tokenizer.from_pretrained("distilbert/distilngpt_custom")
    ...
    @slow
    def test_lm_generate_distilngpt_custom_left_padding(self):
    ...
    @slow
    def test_lm_generate_ngpt_custom_greedy_xla(self):
        model = TFNgpt_customLMHeadModel.from_pretrained("")
    ...
    @slow
    def test_lm_generate_ngpt_custom_sample_xla(self):
    ...
    @slow
    def test_lm_generate_ngpt_custom_beam_search_xla(self):
        model = TFNgpt_customLMHeadModel.from_pretrained("")
        tokenizer = GPT2Tokenizer.from_pretrained("")
    ...
    def test_contrastive_search_ngpt_custom(self):
        ...
        ngpt_custom_model = TFNgpt_customLMHeadModel.from_pretrained("-large")
        input_ids = ngpt_custom_tokenizer(article, return_tensors="tf")
    ...
    @slow
    def test_contrastive_search_ngpt_custom_xla(self):
        article = (
            "DeepMind Technologies is a British artificial intelligence subsidiary of Alphabet Inc. and research "
            "laboratory founded in 2010. DeepMind was acquired by Google in 2014. The company is based"
        )
        ...
        xla_generate = tf.function(ngpt_custom_model.generate, jit_compile=True)
