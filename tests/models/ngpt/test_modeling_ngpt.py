...
class NgptModelTester:
    ...
    def get_large_model_config(self):
        return NgptConfig.from_pretrained("")
    ...
    def create_and_check_ngpt_model(self, config, input_ids, input_mask, head_mask, token_type_ids, *args):
    ...
    def create_and_check_ngpt_model_past(self, config, input_ids, input_mask, head_mask, token_type_ids, *args):
        model = NgptModel(config=config)
        model.to(torch_device)
        model.eval()
    ...
    def create_and_check_ngpt_model_attention_mask_past(
    ...
    def create_and_check_ngpt_model_past_large_inputs(
        self, config, input_ids, input_mask, head_mask, token_type_ids, *args
    ):
        model = NgptModel(config=config)
        model.to(torch_device)
    ...
    def create_and_check_double_lm_head_model(
        ...
        model = NgptDoubleHeadsModel(config)
        model.to(torch_device)
        model.eval()
    ...
    def create_and_check_ngpt_for_question_answering(
        self, config, input_ids, input_mask, head_mask, token_type_ids, mc_token_ids, sequence_labels, *args
    ):
        config.num_labels = self.num_labels
        model = NgptForQuestionAnswering(config)
        model.to(torch_device)
        model.eval()
    ...
    def create_and_check_ngpt_for_sequence_classification(
        self, config, input_ids, input_mask, head_mask, token_type_ids, mc_token_ids, sequence_labels, *args
    ):
        config.num_labels = self.num_labels
        model = NgptForSequenceClassification(config)
        model.to(torch_device)
        model.eval()
        result = model(input_ids, attention_mask=input_mask, token_type_ids=token_type_ids, labels=sequence_labels)
        self.parent.assertEqual(result.logits.shape, (self.batch_size, self.num_labels))

    def create_and_check_ngpt_for_token_classification(
        self, config, input_ids, input_mask, head_mask, token_type_ids, mc_token_ids, sequence_labels, *args
    ):
        config.num_labels = self.num_labels
        model = NgptForTokenClassification(config)
        model.to(torch_device)
        model.eval()
        result = model(input_ids, attention_mask=input_mask, token_type_ids=token_type_ids)
        self.parent.assertEqual(result.logits.shape, (self.batch_size, self.seq_length, self.num_labels))

    def create_and_check_ngpt_weight_initialization(self, config, *args):
...
class NgptModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    all_generative_model_classes = (NgptLMHeadModel, NgptDoubleHeadsModel) if is_torch_available() else ()
    all_parallelizable_model_classes = (NgptLMHeadModel, NgptDoubleHeadsModel) if is_torch_available() else ()
    fx_compatible = False
    ...
    def _prepare_for_class(self, inputs_dict, model_class, return_labels=False):
        ...
        if return_labels:
            if model_class.__name__ == "NgptDoubleHeadsModel":
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(self, config_class=NgptConfig, n_embd=37)
    ...
    def test_ngpt_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_ngpt_model(*config_and_inputs)

    def test_ngpt_model_past(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_ngpt_model_past(*config_and_inputs)

    def test_ngpt_model_att_mask_past(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_ngpt_model_attention_mask_past(*config_and_inputs)

    def test_ngpt_model_past_large_inputs(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_ngpt_model_past_large_inputs(*config_and_inputs)

    def test_ngpt_lm_head_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_lm_head_model(*config_and_inputs)

    def test_ngpt_double_lm_head_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_double_lm_head_model(*config_and_inputs)

    def test_ngpt_question_answering_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_ngpt_for_question_answering(*config_and_inputs)

    def test_ngpt_sequence_classification_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_ngpt_for_sequence_classification(*config_and_inputs)

    def test_ngpt_token_classification_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_ngpt_for_token_classification(*config_and_inputs)

    def test_ngpt_gradient_checkpointing(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_forward_and_backwards(*config_and_inputs, gradient_checkpointing=True)

    def test_ngpt_scale_attn_by_inverse_layer_idx(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs(scale_attn_by_inverse_layer_idx=True)
        self.model_tester.create_and_check_forward_and_backwards(*config_and_inputs)

    def test_ngpt_reorder_and_upcast_attn(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs(reorder_and_upcast_attn=True)
        self.model_tester.create_and_check_forward_and_backwards(*config_and_inputs)

    def test_ngpt_weight_initialization(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_ngpt_weight_initialization(*config_and_inputs)
    ...
    def test_batch_generation(self):
        model = NgptLMHeadModel.from_pretrained("")
        model.to(torch_device)
    ...
    def test_model_from_pretrained(self):
        model_name = ""
        model = NgptModel.from_pretrained(model_name)
        self.assertIsNotNone(model)


@require_torch
class NgptModelLanguageGenerationTest(unittest.TestCase):
    def tearDown(self):
        super().tearDown()
        # clean-up as much as possible GPU memory occupied by PyTorch
        cleanup(torch_device, gc_collect=True)

    def _test_lm_generate_ngpt_helper(
        self,
    ...
    @slow
    def test_lm_generate_ngpt(self):
        self._test_lm_generate_ngpt_helper()

    @slow
    def test_lm_generate_ngpt_with_gradient_checkpointing(self):
        self._test_lm_generate_ngpt_helper(gradient_checkpointing=True)

    @slow
    def test_lm_generate_ngpt_with_reorder_and_upcast_attn(self):
        self._test_lm_generate_ngpt_helper(reorder_and_upcast_attn=True)

    @slow
    def test_lm_generate_ngpt_with_scale_attn_by_inverse_layer_idx(self):
        self._test_lm_generate_ngpt_helper(scale_attn_by_inverse_layer_idx=True, verify_outputs=False)

    @slow
    def test_ngpt_sample(self):
        tokenizer = GPT2Tokenizer.from_pretrained("")
        model = NgptLMHeadModel.from_pretrained("")
        model.to(torch_device)
    ...
    @slow
    def test_ngpt_sample_max_time(self):
        tokenizer = GPT2Tokenizer.from_pretrained("")
        model = NgptLMHeadModel.from_pretrained("")
        model.to(torch_device)
    ...
    @slow
    def test_contrastive_search_ngpt(self):
        article = (
        ...
        ngpt_tokenizer = GPT2Tokenizer.from_pretrained("-large")
        ngpt_model = NgptLMHeadModel.from_pretrained("-large").to(torch_device)
        input_ids = ngpt_tokenizer(article, return_tensors="pt").input_ids.to(torch_device)

        outputs = ngpt_model.generate(input_ids, penalty_alpha=0.6, top_k=4, max_length=256)

        generated_text = ngpt_tokenizer.batch_decode(outputs, skip_special_tokens=True)
    ...
    def test_flash_attn_2_generate_padding_left(self):
        ...
        """
        model = NgptLMHeadModel.from_pretrained("ngpt", torch_dtype=torch.float16).to(0)

        tokenizer = GPT2Tokenizer.from_pretrained("ngpt")
        ...
        model = NgptLMHeadModel.from_pretrained(
            "ngpt", device_map={"": 0}, attn_implementation="flash_attention_2", torch_dtype=torch.float16
        )
