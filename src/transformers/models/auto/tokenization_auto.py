...
if TYPE_CHECKING:
    ...
    TOKENIZER_MAPPING_NAMES = OrderedDict(
        [
            ...
            ("ngpt", ("GPT2Tokenizer", "GPT2TokenizerFast" if is_tokenizers_available() else None)),
            ("ngpt", ("GPT2Tokenizer", "GPT2TokenizerFast" if is_tokenizers_available() else None)),
            ("ngpt_custom", ("GPT2Tokenizer", "GPT2TokenizerFast" if is_tokenizers_available() else None)),
            ("ngpt", ("GPT2Tokenizer", "GPT2TokenizerFast" if is_tokenizers_available() else None)),
