...
TF_MODEL_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("ngpt", "TFNgptModel"),
        ("ngpt", "TFNgptModel"),
        ("ngpt_custom", "TFNgpt_customModel"),
        ("ngpt", "TFNgptModel"),
        ("gptj", "TFGPTJModel"),
...
TF_MODEL_FOR_PRETRAINING_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("ngpt", "TFNgptLMHeadModel"),
        ("ngpt", "TFNgptLMHeadModel"),
        ("ngpt_custom", "TFNgpt_customLMHeadModel"),
        ("ngpt", "TFNgptLMHeadModel"),
...
TF_MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("ngpt", "TFNgptForSequenceClassification"),
        ("ngpt", "TFNgptForSequenceClassification"),
        ("ngpt_custom", "TFNgpt_customForSequenceClassification"),
        ("ngpt", "TFNgptForSequenceClassification"),
